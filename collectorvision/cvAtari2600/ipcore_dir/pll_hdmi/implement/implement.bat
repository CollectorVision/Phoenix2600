...
xst -ifn xst.scr
move pll_hdmi_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll_hdmi_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll_hdmi_exdes.ucf pll_hdmi_exdes

echo 'Running map'
map -timing -pr b pll_hdmi_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm pll_hdmi_exdes -w routed.ncd routed.vhd
cd ..
